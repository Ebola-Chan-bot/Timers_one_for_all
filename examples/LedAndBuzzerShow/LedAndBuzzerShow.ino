...
void setup() {
  ...
  digitalWrite(LED, HIGH);
  LEDTimer->DoubleRepeat(std::chrono::seconds(2), Quick_digital_IO_interrupt::DigitalWrite<LED, LOW>, std::chrono::seconds(1), Quick_digital_IO_interrupt::DigitalWrite<LED, HIGH>, InfiniteRepeat);
